...
mod tests {
    ...
    fn test_ai_client_multiple_instances() {
        ...
        let client1 = AiClient::new(config1, Arc::new(ExportConfigService::new()));
        let client2 = AiClient::new(config2, Arc::new(ExportConfigService::new()));

        // Multiple clients should be creatable
        assert!(client1.is_ok() && client2.is_ok());
    }
